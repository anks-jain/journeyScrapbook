...
<html>
	<header>
		...
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBqOSpe5NX2eude-qj1A0LMgyKs6-xWwys&v=3.exp&sensor=false&libraries=places" type="text/javascript"></script>
        ...
        <?php 
					for($i = 0; $i < $array_size;$i++) {
						?>
						markers[i] =	createMarker(new google.maps.LatLng(<?php echo $latitude_array[$i]?>,<?php echo $longitude_array[$i] ?>),"<?php echo $i; ?>","<?php echo $pic_thumb_array[$i]; ?>",map);
						i=i+1;
        ...
        ?>
			...
			function createMarker(pos, t, thumbnail,map) {
  					...
  					<div class="carousel-inner">
    					<div class="item active">
      					...
      					<div class="carousel-caption">
        					<p><?php echo $_COOKIE["Marker"].index; ?></p>
      					</div>
    					</div>
    					<div class="item">
      					<img src="http://placehold.it/1200x480" alt="" />
